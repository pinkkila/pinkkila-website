      ...
      <section className="py-10 md:py-22">
        <div className="mx-auto max-w-5xl px-6">
          <div className="grid gap-6 md:grid-cols-2 md:gap-12">
            <div>
              <h2 className="text-4xl font-medium">Full-Stack</h2>
              <h2 className="text-4xl font-medium">Java</h2>
              <h2 className="text-4xl font-medium">Spring Boot</h2>
              <h2 className="text-4xl font-medium">TypeScript</h2>
              <h2 className="text-4xl font-medium">React</h2>
              <h2 className="text-4xl font-medium">AWS</h2>
              <h2 className="text-4xl font-medium">Linux</h2>
              <h2 className="text-4xl font-medium">Learning</h2>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p>
                ...
                also covered penetration testing and network security, giving
                me a strong awareness of modern security challenges and the
